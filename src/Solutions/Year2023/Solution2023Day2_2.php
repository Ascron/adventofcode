 ...
 */
class Solution2023Day2_2 extends AbstractSolution implements SolutionInterface
{
    public function solve(string $input): string
    {
        ...
        foreach (Lines::fromInput($input) as $line) {
            ...
            $power = ($ballCounts['red'] ?? 0) * ($ballCounts['green'] ?? 0) * ($ballCounts['blue'] ?? 0);
            $result += $power;
        }
